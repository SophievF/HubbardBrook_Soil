...
avgC_A <- ggplot() +
  geom_smooth(data=HBByearavgs_A, aes(x=Year, y=avgC), color="lightcoral", fill="pink")+
...
avgN_A <- ggplot() +
  geom_smooth(data=HBByearavgs_A, aes(x=Year, y=avgN), color="midnightblue", fill="lightskyblue")+
